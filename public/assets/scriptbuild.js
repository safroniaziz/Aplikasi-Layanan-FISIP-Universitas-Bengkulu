...
function he(e, t) {
    return typeof t == "object" && t !== null ? dr(e, t) : pr(e, t);
}
function dr(e, t) {
    let n = {};
    return (
...
g(
    ...
    (e, { value: t, modifiers: n, expression: r }, { evaluate: i }) => {
        typeof r == "function" && (r = i(r)),
            r !== !1 &&
                (!r || typeof r == "boolean" ? gr(e, n, t) : hr(e, r, t));
    }
);
function hr(e, t, n) {
    tn(e, nt, ""),
...
function Er(e, t) {
    if (e.type === "radio")
        ...
        Number.isInteger(t)
            ...
            : (e.checked = !!t);
    else if (e.tagName === "SELECT") Tr(e, t);
    else {
        if (e.value === t) return;
        e.value = t === void 0 ? "" : t;
    }
...
var Hr = Object.freeze({}),
    ...
    gn = (e) => hn(e).slice(8, -1),
    it = (e) =>
        Wr(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e,
    Vr = (e) => {
        const t = Object.create(null);
        return (n) => t[n] || (t[n] = e(n));
    },
    Jr = Vr((e) => e.charAt(0).toUpperCase() + e.slice(1)),
    xn = (e, t) => e !== t && (e === e || t === t),
    Ke = new WeakMap(),
    V = [],
    A,
...
function Xr(e) {
    e.active &&
        (yn(e), e.options.onStop && e.options.onStop(), (e.active = !1));
}
var Qr = 0;
function Zr(e, t) {
    const n = function () {
...
var ni = zr("__proto__,__v_isRef,__isVue"),
    bn = new Set(
...
function mn(e = !1, t = !1) {
    return function (r, i, o) {
        ...
        if (i === "__v_raw" && o === (e ? (t ? mi : An) : t ? bi : Sn).get(r))
            return r;
        const s = F(r);
        if (!e && s && xe(gt, i)) return Reflect.get(gt, i, o);
        const a = Reflect.get(r, i, o);
        return (rt(i) ? bn.has(i) : ni(i)) || (e || E(r, "get", i), t)
            ? a
            : ke(a)
            ? !s || !it(i)
                ? a.value
...
function ai(e = !1) {
    return function (n, r, i, o) {
        ...
        return (
            n === h(o) &&
                (a ? xn(i, s) && $(n, "set", r, i, s) : $(n, "add", r, i)),
            u
        );
    };
}
...
var fi = { get: ri, set: si, deleteProperty: ui, has: ci, ownKeys: li },
    di = {
        get: ii,
        set(e, t) {
            return (
...
function yt(e, t) {
    ...
    return (
        n.set(e, t),
        o ? xn(t, s) && $(n, "set", e, t, s) : $(n, "add", e, t),
        this
    );
}
function vt(e) {
...
function Ei(e) {
    return e.__v_skip || !Object.isExtensible(e) ? 0 : wi(gn(e));
}
function ct(e) {
    return e && e.__v_isReadonly ? e : Cn(e, !1, fi, yi, Sn);
}
function On(e) {
    return Cn(e, !0, di, vi, An);
}
...
S(
    "refs",
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = te(Si(e))), e._x_refs_proxy)
);
function Si(e) {
    let t = [],
        n = e;
...
function ze(e, t, n, r) {
    let i = e,
        ...
        a = (u, c) => (l) => c(u, l);
    if (
        (n.includes("dot") && (t = Mi(t)),
        n.includes("camel") && (t = Ti(t)),
    ...
    n((s) => {
        ...
        for (let f = 0; f < d.length; f++) {
            ...
            let w = c[x],
                ...
                lt = z(w);
            ee(W, lt, o),
                (W._x_refreshXForScope = (jn) => {
                    Object.entries(jn).forEach(([Nn, Ln]) => {
                        lt[Nn] = Ln;
                    });
                }),
                v(() => {
...
ne.setEvaluator(Wt);
ne.setReactivityEngine({ reactive: ct, effect: Gr, release: Xr, raw: h });
var Di = ne,
    Rn = Di;
window.Alpine = Rn;
Rn.start();
