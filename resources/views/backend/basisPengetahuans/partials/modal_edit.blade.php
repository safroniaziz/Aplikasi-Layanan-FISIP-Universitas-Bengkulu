<div class="modal fade" id="modalEdit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('basisPengetahuan.update') }}" method="POST" id="form">
                {{ csrf_field() }} {{ method_field('PATCH') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Edit Basis Pengetahuan</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="pertanyaan" class="form-control" id="pertanyaan_edit" cols="30" rows="3"></textarea>
                        </div>

                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Jawaban</label>
                            <textarea name="jawaban" class="form-control" id="jawaban_edit" cols="30" rows="3"></textarea>
                        </div>
                    </div>
                </div>
