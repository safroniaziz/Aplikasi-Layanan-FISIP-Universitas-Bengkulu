...
<a href="{{ route('user') }}" class="px-2 py-2 mx-2 mt-2  active-menu lg:text-white  text-[14px] text-sh transition-colors  duration-300 transform rounded-md
...
<!-- <a href="{{route('tampilJadwal')}}" class="px-2 py-2 mx-2 mt-2 text-gray-600 lg:text-white  text-[14px] text-sh transition-colors duration-300 transform rounded-md lg:mt-0 hover:text-[#eed488]       ">Jadwal
    Matkul</a> -->
<a href="{{route('tampilJadwalLivewire')}}" class="px-2 py-2 mx-2 mt-2 text-gray-600 lg:text-white  text-[14px] text-sh transition-colors duration-300 transform rounded-md lg:mt-0 hover:text-[#eed488]       ">Jadwal
    Matkul</a>
...
<a href="{{ route('bukuTamu') }}" class="px-2 py-2 mx-2 mt-2 text-gray-600 lg:text-white  text-[14px] text-sh transition-colors
