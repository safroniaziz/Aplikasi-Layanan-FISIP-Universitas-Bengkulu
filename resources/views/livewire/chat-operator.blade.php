                    ...
                    <form wire:submit.prevent="kirimPesan({{ $id }})" method="POST">
                        <div class="bg-gray-300 p-4">
                            <div class="relative flex ">
                                ...
                                <input name="pesan" wire:model="pesan" type="text" placeholder="Tuliskan pesan anda!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-3 pr-28 bg-white rounded-md py-3 text-sm">
