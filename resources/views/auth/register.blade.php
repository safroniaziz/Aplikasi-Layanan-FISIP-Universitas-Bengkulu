...
<body id="home" class=" font-[Poppins] 2xl:text-xl font-nunito      text-slate-900 bg-gradient-to-r
    ...
    <div class="bg-pattren  ">
        ...
        <!-- Preloader Start -->
        <!-- navbar  -->
        <nav class=" relative top-0 z-50 w-full    font-[Poppins]    ">
                        ...
                        <div class="flex   z-50">
                            <div x-data="{ toggle: localStorage.getItem('theme') === 'dark' }" :class="toggle ? 'dark' : ''" class=" app mx-auto py-3 lg:py-0">
                                <button title="Change Mode" id="theme-toggle" @click="toggle = !toggle" class="flex items-center w-full p-2 group text-sm text-gray-600 transition-colors duration-300 transform rounded-bl-full md:p-5 dark:text-gray-50 dark:hover:text-whitecapitalize ">
                                    <svg class="group-hover:fill-yellow-500 stroke-yellow-600 md:stroke-gray-100 dark:stroke-gray-100" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <!-- Sun -->
                                    ...
                                    <span class="lg:hidden ml-2 text-gray-600 lg:text-white dark:text-gray-200 group-hover:text-yellow-500
            ...
            <div class=" container mx-auto z-10     relative">
                <div class="  px-8 lg:px-12 text-gray-700 dark:text-white shadow-lg  mx-auto bg-white dark:bg-black dark:bg-opacity-30
                    ...
                    <form method="POST" action="{{route('register')}}">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-x-6 gap-y-2 my-3">
                            <div class=" col-span-1  ">
                                ...
                                <input type="text" name="name" class="   w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                ...
                                dark:focus:shadow-[-4px_4px_10px_0px_#eab308] " placeholder="Nama Lengkap" />
                                @error('name')
                                <p class="text-red-500 text-xs font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class=" col-span-1  ">
                                <label class=" after:content-['*'] after:text-red-500 font-semibold text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-2">Username</label>
                                <input type="text" name="username" class="   w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                                dark:focus:shadow-[-4px_4px_10px_0px_#eab308]  " placeholder="Username" />
                                @error('username')
                                <p class="text-red-500 text-xs font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class=" col-span-1  ">
                                ...
                                <input type="email" name="email" class="   w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2 my-3">
                            ...
                            <div class=" col-span-1  ">
                                ...
                                <input type="text" name="no_hp" class="   w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                                dark:focus:shadow-[-4px_4px_10px_0px_#eab308]  " placeholder="Nomor Telepon" />
                                @error('no_hp')
                                <p class="text-red-500 text-xs font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class=" col-span-1  ">
                                <label class=" after:content-['*'] after:text-red-500 font-semibold text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-2">Pekerjaan</label>
                                <input type="text" name="pekerjaan" class="   w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                                dark:focus:shadow-[-4px_4px_10px_0px_#eab308]  " placeholder="Pekerjaan" />
                                @error('pekerjaan')
                                <p class="text-red-500 text-xs font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class=" col-span-1  ">
                                <label class=" after:content-['*'] after:text-red-500 font-semibold text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-2">Status</label>
                                <select name="status" class="   w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                    bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                    placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                    dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                    focus:shadow-[-4px_4px_10px_0px_#01052D]
                                    dark:focus:shadow-[-4px_4px_10px_0px_#eab308]  " id="">
                                    <option disabled selected>-- pilih status --</option>
                                    <option value="mahasiswa">Mahasiswa</option>
                                    <option value="pelajara">Pelajar</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2  gap-x-6 gap-y-2 my-3">
                            <div class=" col-span-1 " x-data=" { show: false }">
                                <label class="   text-gray-700 dark:text-gray-300 font-semibold after:ml-2 text-sm
                                    pb-2">Password</label>
                                <div class="relative flex items-center ">
                                    <input name="password" :type=" show ? 'text': 'password' " type="password" class="w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                            ...
                            <div class="col-span-1  " x-data="{ show: false }">
                                <label class="   text-gray-700 dark:text-gray-300 font-semibold after:ml-2 text-sm
                                    pb-2">Konfirmasi Password</label>
                                <div class="relative flex items-center ">
                                    <input name="password_confirmation" :type=" show ? 'text': 'password' " type="password" class=" w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                                dark:focus:shadow-[-4px_4px_10px_0px_#eab308] " placeholder="Konfirmasi Password" />
                                    <span class="absolute right-2 pt-1 bg-transparent flex items-center justify-center cursor-pointer " @click="show = !show">
                                        <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21">
                                            </path>
                        ...
                        <div class="grid grid-cols-1   gap-x-6 gap-y-2 my-3">
                            ...
                            <div class=" col-span-1  ">
                                <label class=" after:content-['*'] after:text-red-500 font-semibold text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-2">Alamat</label>
                                <textarea name="alamat" class="  h-28 w-full rounded-lg border-2 mt-1 border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                                dark:focus:shadow-[-4px_4px_10px_0px_#eab308]  " placeholder="Alamat"></textarea>
                                @error('alamat')
                                <p class="text-red-500 text-xs font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-10 w-full grid">
                            <button class=" h-full  rounded-lg border-2 inline-block max-w-md  mx-auto mt-1 w-full text-white border-blue-600 dark:border-yellow-600 bg-[#091150] dark:bg-yellow-500 hover:bg-blue-600 duration-300 transform dark:hover:bg-yellow-600 font-medium tracking-widest py-2
                    ...
                    <div class="mt-3 w-full grid">
                        <a href="{{ route('login') }}" class=" h-full inline-block max-w-md  mx-auto  text-center rounded-lg border-2 mt-1 w-full border-[#091150]
        ...
        <div class="relative">
            ...
            <svg viewBox="0 0 1522 196" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="fill-[#01052D] duration-300 transform     bottom-0 z-0 2xl:mb-0  " style="transform: rotateY(180deg); transform: rotate(180deg);">
                <path d="M 0 0 C 102 0 0 -11 102 -11 L 102 -11 L 102 0 L 0 0 Z" stroke-width="0">
                </path>
                <path d="M 101 -11 C 1522 -11 101 122 1522 122 L 1522 122 L 1522 0 L 101 0 Z" stroke-width="0"></path>
            </svg>
