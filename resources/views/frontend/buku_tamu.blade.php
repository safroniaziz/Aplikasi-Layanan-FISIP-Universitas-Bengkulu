...
<body id="home"
    class=" font-[Poppins] 2xl:text-xl font-nunito overflow-hidden h-screen text-slate-900
    ">
    ...
    <section class="  items-center w-full  duration-300 transform
        ...
        <div class="flex container mx-auto z-10 overflow-hidden h-screen justify-center relative">
            ...
            <div class="col-span-1 lg:mt- 2xl:mt-0 lg:block hidden ">
                <lottie-player src="{{ asset('assets/user/src/hMbBtnOpBo.json') }}" background="transparent" speed="1"
                    class="w-full mx-auto lottie-login px-12" loop autoplay></lottie-player>
            </div>
                    ...
                    <form action="{{ route('bukuTamu.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5   my-2">
                            <div class=" col-span-1  ">
                                <label
                                    class=" after:content-['*'] after:text-red-500 font-semibold  text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-1">Nama Lengkap</label>
                            ...
                            <div class=" col-span-1  ">
                                <label
                                    class=" after:content-['*'] after:text-red-500 font-semibold  text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-1">Bertamu Dengan</label>
                        ...
                        <div class="grid grid-cols-1   gap-x-6  ">
                            <div class=" col-span-1  ">
                                <label
                                    class=" after:content-['*'] after:text-red-500 font-semibold  text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-1">Tuliskan Keperluan</label>
                                <textarea class="  h-20 w-full rounded-lg border-2  border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5   my-2 ">
                            <div class=" col-span-1  ">
                                <label
                                    class=" after:content-['*'] after:text-red-500 font-semibold  text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-1">Nomor HP/WA</label>
                                <input type="text" class="   w-full rounded-lg border-2  border-[#01052D] dark:border-yellow-500
                                bg-transparent px-3 py-2.5 text-sm font-normal text-white-700 transition-all duration-500
                                placeholder:text-gray-600 dark:placeholder:text-yellow-100 focus:border-white
                                dark:focus:ring-yellow-500 focus:ring-[#01052D]
                                focus:shadow-[-4px_4px_10px_0px_#01052D]
                            ...
                            <div class=" col-span-1  ">
                                <label
                                    class=" after:content-['*'] after:text-red-500 font-semibold  text-gray-700 dark:text-gray-300 after:ml-2 text-sm pb-1">Ambil Foto </label>
                                    <br>
