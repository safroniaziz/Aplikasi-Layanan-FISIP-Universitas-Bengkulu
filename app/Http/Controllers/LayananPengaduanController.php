...
class LayananPengaduanController extends Controller
{
    ...
    public function store(Request $request){
        $rules = [
            ...
            'bukti_pendukung'       => 'required|file|mimes:pdf|max:2048', // Menambahkan validasi file PDF maksimal 2 MB
        ];

        $text = [
            'unit_tujuan.required'         => 'Unit Tujuan harus diisi.',
            'pokok_permasalahan.required'  => 'Pokok Permasalahan harus diisi.',
            'bukti_pendukung.required'     => 'Bukti Pendukung harus diisi.',
